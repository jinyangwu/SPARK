...
torchrun  --standalone --nnodes=1 --nproc_per_node=4 \
    ...
    trainer.experiment_name=${ENV}_qwen7b_cold-start_$cs_data_name \
    trainer.total_epochs=3 \
    trainer.default_local_dir="your_path_to_local_dir/spark_${ENV}_qwen7b_cold-start_$cs_data_name" \
