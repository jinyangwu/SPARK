...
SAVE_PATH=your_path_to_save_spark_sciworld_rl_checkpoints
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='spark_sciworld' \
    trainer.experiment_name=spark_sciworld_qwen2.5_1.5b_cs_his-5_ini-${initial_n}_branch-${branch_count}_group-${group_size}_explore_bsz16 \
    trainer.n_gpus_per_node=4 \
    trainer.nnodes=1 \
    trainer.save_freq=5 \
    trainer.test_freq=5 \
    trainer.total_epochs=120 \
    trainer.default_local_dir=$SAVE_PATH/spark_sciworld_qwen2.5_1.5b_cs_his-5_ini-${initial_n}_branch-${branch_count}_group-${group_size}_explore_bsz16 \
    trainer.rollout_data_dir=$SAVE_PATH/spark_sciworld_qwen2.5_1.5b_cs_his-5_ini-${initial_n}_branch-${branch_count}_group-${group_size}_explore_bsz16 \
